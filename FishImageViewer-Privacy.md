...
This privacy policy applies to the Fish Image Viewer app (hereby referred to as "Application") for mobile devices that was created by Jinyu Meng (hereby referred to as "Service Provider") as a Commercial service. This service is intended for use "AS IS".
